...
export default function CardOfBlog4() {
  return (
          <>
          <div className='mainOfCard'>
          <img src="news-1.jpg" alt=""  className='imgOfBlog'/>
          <main className='card'>
            <div>
                <CgProfile />
                <p className='person'>Farah</p>
                <hr />
                <p>0</p>
            </div>
            <div>
                <p className='categofcard'><TbFolderFilled /> Computer</p>
